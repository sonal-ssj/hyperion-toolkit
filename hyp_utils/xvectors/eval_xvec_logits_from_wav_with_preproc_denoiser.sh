...
denoiser_model_G_num_speakers=0
denoiser_model_ctn_layer=0
denoiser_model_encoder_dim=0
...
if [ $# != 3 ] && [ $# != 4 ]; then
  ...
  echo "  --denoiser_model_G_num_speakers                  # Denoiser G number of  speakers" 
  echo "  --denoiser_model_ctn_layer                       # Denoiser model number of layers" 
