...
def extract_xvectors_with_preproc_denoiser(input_spec, output_spec, vad_spec, write_num_frames_spec,
                     ...
                     use_gpu, denoiser_model_path, denoiser_model_load_string, denoiser_model_G_num_speakers, denoiser_model_name_predict, denoiser_model_ctn_layer, denoiser_model_encoder_dim, denoiser_model_two_stream, denoiser_model_two_stream_use_benign, **kwargs):
...
if __name__ == "__main__":
    ...
    parser=ArgumentParser(
        description=('Extracts x-vectors from waveform computing using denoiser as pre-processor acoustic features on the fly'))
    ...
    extract_xvectors_with_preproc_denoiser(**namespace_to_dict(args))
