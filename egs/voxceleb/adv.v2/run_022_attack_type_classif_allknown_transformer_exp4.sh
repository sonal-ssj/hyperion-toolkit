...
# config_file=default_config_transformer.sh # Sonal changed parameters
#config_file=default_config_transformer_exp1.sh # Jesus suggested parameters
#config_file=default_config_transformer_exp2.sh # Original parameters
#config_file=default_config_transformer_exp3.sh # Jesus suggested parameters + original lr_schedule parameters
config_file=default_config_transformer_exp4.sh # Original parameters including chunk size = 400 
#config_file=default_config_transformer_exp5.sh # exp3 + chunksize = 400 
...
if [ $stage -le 2 ]; then
    ...
    if [ ! -f $list_dir/test/wav.scp ]
    then
    echo "test/wav.scp File does not exist, making it"
