...
denoiser_model_exp_name=2000
denoiser_model_ckpt=12_0.0012_-0.0.pt

denoiser_model_name_predict='BP' # Predicts adv perturb

denoiser_model_load_string=G
denoiser_model_G_num_speakers=2
denoiser_model_ctn_layer=8
denoiser_model_encoder_dim=128
denoiser_model_two_stream=True
