...
sign_nnet_config=conf/transformer_exp2_atnet.yaml
sign_nnet_name=transformer_exp2

sign_nnet_batch_size_1gpu=64 ## Changed as per transformer config in hyperion
