# Experiments using LResNet34 for x-vector extractor 
# and Transformer for attack signature extractor
...
# Attack model Transformer configuration                            #### TO CHANGE
sign_nnet_command=transformer
sign_nnet_config=conf/transformer_atnet.yaml
sign_nnet_batch_size_1gpu=128
sign_nnet_eff_batch_size=512 # effective batch size
sign_nnet_name=transformer
