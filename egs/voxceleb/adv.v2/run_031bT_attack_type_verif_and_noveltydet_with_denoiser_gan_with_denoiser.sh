...
stage=1
ngpu=1
config_file=global_conf/config_spknet_fbank80_stmn_lresnet34_attacknet_transformer.v1.sh
resume=false
interactive=false
num_workers=4
xvec_use_gpu=false
...
#sign_nnet_reldir=$spknet_name"_preprocess_denoiser_gan"/$sign_nnet_name/$sk_attack_type_split_tag
...
denoiser_model_path=exp/denoiser_model_someknown//BWE-2/184/14_0.0002_0.0.pt # GAN Model trained by SK leaving out CW attacks
...
sign_nnet_reldir=$spknet_name"_preprocess_denoiser_gan"/$sign_nnet_name/$sk_attack_type_split_tag
sign_nnet_dir=exp/sign_nnets/$sign_nnet_reldir
sign_nnet_reldir_sign_with_denoiser=$spknet_name"_preprocess_denoiser_gan_with_denoiser"/$sign_nnet_name/$sk_attack_type_split_tag
...
if [ $stage -le 1 ]; then
    ...
    $cuda_cmd --gpu $ngpu $sign_nnet_dir/log/train.log \
        ...
        torch-train-xvec-from-wav-with-preprocess-denoiser.py  $sign_nnet_command --cfg $sign_nnet_config \
        ...
        --denoiser_model_n_layers $denoiser_model_n_layers $args
fi
